...
file_to_load = os.path.join("/Users/codymauc/Desktop", "Resources", "election_results.csv")
# Add a variable to save the file to a path.
file_to_save = os.path.join("/Users/codymauc/Documents/Bootcamp/UNC-VIRT-DATA-PT-05-2022-U-B/assignments/03-PyPoll/Resources", "election_analysis.txt")
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes_dict:
        ...
        largest_county = max(county_votes_dict, key=county_votes_dict.get)
